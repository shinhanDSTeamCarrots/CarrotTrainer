package xyz.teamcarrot.myct.config;
...
@Configuration
@ComponentScan(basePackages = {"xyz.teamcarrot.myct"})
@EnableWebMvc
@MapperScan(basePackages = {"xyz.teamcarrot.myct"}, annotationClass = Mapper.class) // 인터페이스 스캔
