...
public class MemberServiceImpl implements MemberService {
	 ...
	 * @Override
	 * 
	 * @Transactional public boolean deleteMember(@Param("member_id") String
	 * member_id, @Param("member_pw") String member_pw) { // 비밀번호 일치 여부 확인 및 회원 삭제
	 * int affectedRows = mapper.deleteMember(member_id, member_pw);
	 * 
	 * // 삭제된 행이 1개 이상이면 삭제 성공 return affectedRows > 0; }
	 */
	@Override
	...
	@Override
	public List<InterestVO> interestSelect(int mem_no) {
		return mapper.interestSelect(mem_no);
	}
